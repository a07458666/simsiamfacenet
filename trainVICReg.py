...
def train(args, model, train_loader, val_loader, writer, device):
    ...
    # val_loss_history = []
    # val_loss_sim_history = []
    # val_loss_var_history = []
    # val_loss_cov_history = []
    ...
    for epoch in range(args.epochs):
        ...
        print("-" * 10)
        loss, train_loss_sim, train_loss_var, train_loss_cov = pass_epoch(
            args,
            model,
            train_loader,
            model_optimizer,
        ...
        # with torch.no_grad():
        #     val_loss,  val_loss_sim, val_loss_var, val_loss_cov = pass_epoch(
        #         args,
        #         model,
        #         val_loader,
        #         model_optimizer,
        ...
        # val_loss_sim_history.append(val_loss_sim)
        # val_loss_var_history.append(val_loss_var)
        # val_loss_cov_history.append(val_loss_cov)
        ...
        if train_loss <= min_train_loss:
            ...
            torch.save(
                model.encoder,"model/{}/checkpoint.pth.tar".format(args.output_foloder))
            # stop = 0
        # else:
        #     stop += 1
        #     if stop > 10:
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="VICReg")
    parser.add_argument(
